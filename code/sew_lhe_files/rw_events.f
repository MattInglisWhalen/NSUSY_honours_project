      subroutine read_event(lun,P,wgt,nexternal,ic,ievent,scale,aqcd,
     c  aqed,buff2,done,anti)
c********************************************************************
...
c-----     
 ...
 11   read(lun,'(a256)',end=99,err=99) buff
     ...
     $     (p(j,i),j=1,3),p(0,i),p(4,i),xdum1,xdum2
         ic(7,i)=xdum2
         if( ic(1,i) .ne. 21 .and. ic(1,i) .ne. 22 .and. ic(1,i) .ne. 23
     c .and. ic(1,i) .ne. 35 .and. ic(1,i) .ne. 36 .and. ic(1,i) .ne. 36
     c .and. ic(1,i) .ne. 36 .and. ic(1,i) .ne. 36 .and. ic(1,i) .ne. 36 
     c .and. ic(1,i) .ne. 1000021 .and. ic(1,i) .ne. 1000022
     c .and. ic(1,i) .ne. 1000023 .and. ic(1,i) .ne. 1000025
     c .and. ic(1,i) .ne. 1000035  ) then
           ic(1,i)=ic(1,i)*anti
         endif
      enddo
      do while(index(buff,"</event") .eq. 0)
