...
void plot_excl_br_curves_GOMED_T1_WINO_BINO(char* stordir,char* ansystag,char* ztag=""){
...
//  canv->SetGridy();
  ...
  pdfname->append(ansystag); pdfname->append("_GOMED_T1_WINO_BINO.pdf");
